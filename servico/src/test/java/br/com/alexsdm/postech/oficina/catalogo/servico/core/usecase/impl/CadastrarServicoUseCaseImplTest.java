...
import br.com.oficina.catalogo.servico.core.usecase.impl.CadastrarServicoUseCaseImpl;
...
class CadastrarServicoUseCaseImplTest {
    ...
    void deveCadastrarServicoComSucesso() {
        ...
        when(servicoRepository.cadastrar(any(Servico.class))).thenAnswer(invocation -> {
