package br.com.oficina.catalogo.common.aop;
...
public class LoggingAspect {
    ...
    // Removed logUseCase as it was specific to the 'oficina' module and its package structure.
    // If 'catalogo' has a similar "use case" pattern, a new pointcut can be added.
