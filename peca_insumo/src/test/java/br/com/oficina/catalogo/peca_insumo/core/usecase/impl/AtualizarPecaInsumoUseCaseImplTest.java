...
import br.com.oficina.catalogo.peca_insumo.core.usecase.impl.AtualizarPecaInsumoUseCaseImpl;
...
class AtualizarPecaInsumoUseCaseImplTest {
    ...
    void deveAtualizarPecaInsumoComSucesso() {
        ...
        verify(pecaInsumoRepository, times(1)).atualizar(pecaCaptor.capture());
    ...
    void deveLancarExcecaoQuandoPecaInsumoNaoEncontradaParaAtualizar() {
        ...
        verify(pecaInsumoRepository, never()).atualizar(any(PecaInsumo.class));
    }
}
