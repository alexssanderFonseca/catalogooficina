...
import br.com.oficina.catalogo.peca_insumo.core.usecase.impl.ListarPecasInsumoUseCaseImpl;
...
class ListarPecasInsumoUseCaseImplTest {
    ...
    void deveRetornarPaginaDePecasComSucesso() {
        ...
        when(pecaInsumoRepository.listar(0L, 10L)).thenReturn(pageRequest);
