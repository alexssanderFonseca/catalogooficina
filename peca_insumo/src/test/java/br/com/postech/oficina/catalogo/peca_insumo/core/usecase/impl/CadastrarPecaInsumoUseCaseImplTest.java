...
import br.com.oficina.catalogo.peca_insumo.core.usecase.impl.CadastrarPecaInsumoUseCaseImpl;
...
class CadastrarPecaInsumoUseCaseImplTest {
    ...
    void deveCadastrarPecaInsumoComSucesso() {
        ...
        when(pecaInsumoRepository.cadastrar(any(PecaInsumo.class))).thenAnswer(invocation -> invocation.getArgument(0));
