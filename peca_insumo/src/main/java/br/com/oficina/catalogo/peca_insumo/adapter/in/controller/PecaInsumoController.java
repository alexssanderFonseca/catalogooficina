...
import br.com.oficina.catalogo.peca_insumo.adapter.in.controller.request.DarBaixaEstoqueRequest; // Adicionado
...
public class PecaInsumoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<?> atualizar(@PathVariable(name = "id") UUID id, @RequestBody @Valid AtualizarPecaInsumoRequest request) {
    ...
    @DeleteMapping("/{id}")
        ...
        @Operation(summary = "Realizar baixa de estoque de peças/insumos")
        @ApiResponses(value = {
                @ApiResponse(responseCode = "204", description = "Baixa de estoque realizada com sucesso"),
